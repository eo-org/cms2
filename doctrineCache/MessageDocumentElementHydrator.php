 ...
 */
class MessageDocumentElementHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        if (isset($data['classNames'])) {
            ...
            $return = (string) $value;
            $this->class->reflFields['classNames']->setValue($document, $return);
            $hydratedData['classNames'] = $return;
        }
        return $hydratedData;
    }
}